...
var autoMenuA=$('.site-auto-menu a');if(!(autoMenuA.attr('data-animation'))){var animation=parseInt(Math.floor(Math.random()*67)+1).toString()}else{var animation=autoMenuA.data('animation').toString()}
...
NextAnimating=!0;$currentPage.removeClass('pt-page-relative');var $nextPage=$('section[data-id='+gotoPage+']').addClass('pt-page-current');$nextPage.scrollTop(0);$('.site-main').scrollTop(0);$currentPage.addClass(outClass).on(animEndEventName,function(){CurrentAnimating=!1;$currentPage.attr('class',$currentPage.data('originalClassList'));$currentPage.off(animEndEventName)});$nextPage.addClass(inClass).on(animEndEventName,function(){NextAnimating=!1;$nextPage.attr('class',$nextPage.data('originalClassList')+' pt-page-current pt-page-relative');$nextPage.off(animEndEventName)})}else{CurrentAnimating=!1;NextAnimating=!1}
if(!support){onEndAnimation($currentPage,$nextPage)}}
function init(options){$('.pt-page').each(function(){var $page=$(this);$page.data('originalClassList',$page.attr('class'))});if(sectionsContainer.hasClass('animated-sections')){sectionsContainer.each(function(){if(location.hash===""){$('section[data-id='+pageStart+']').addClass('section-active')}});$('.nav-anim:not(.nav-custom)').on("click",function(e){e.preventDefault();if(NextAnimating||CurrentAnimating){return!1}
var pageTrigger=$(this);activeMenuItem(pageTrigger);Animate(pageTrigger);location.hash=$(this).attr('href')})}else{var menu_html="";$('.pt-wrapper').find('section.pt-page').each(function(){var slug=$(this).attr('data-id');var page_title=$(this).attr('data-title');if(slug.length){var menu_item='<li><a href="#'+slug+'" class="pt-trigger">'+page_title+'</a></li>'}else{var menu_item=''}
menu_html+=menu_item;$('.site-auto-menu').html(menu_html)});$('.pt-trigger').click(function(){if(NextAnimating||CurrentAnimating){return!1}
var pageTrigger=$(this),menuLink=$(this);activeMenuItem(menuLink);Animate(pageTrigger);history.pushState('','New URL: '+$(this).attr('href'),$(this).attr('href'))})}
window.onpopstate=function(event){if(location.hash){if(NextAnimating==!0||CurrentAnimating==!0){return!1}
var menuLink=$(menu+' a[href*="'+location.hash.split('/')[0]+'"]');activeMenuItem(menuLink);Animate(menuLink)}};var menu=options.menu,pageStart=getActiveSection();location.hash=pageStart;var menuLink=$(menu+' a[href*="'+location.hash.split('/')[0]+'"]');activeMenuItem(menuLink);Animate(menuLink);$(".lmpixels-arrow-right").click(function(){if(sectionsContainer.hasClass('animated-sections')){var activeItem=$('.main-menu li.active').closest(".menu-item-object-page"),menuItem=$('.site-main-menu > .menu-item-object-page:not(.menu-item-has-children)');activeItem.nextAll(".site-main-menu > .menu-item-object-page:not(.menu-item-has-children)").children("a").click();menuItem.last().addClass("last-anim");menuItem.first().addClass("first-anim");if(activeItem.hasClass('last-anim')){$('.main-menu .first-anim').children("a").click()}}else{var activeItem=$('.site-main-menu li.active');activeItem.next("li").children("a").click();if(activeItem.is(':last-child')){$('.site-main-menu li:first-child').children("a").click()}}});$(".lmpixels-arrow-left").click(function(){if(sectionsContainer.hasClass('animated-sections')){var activeItem=$('.main-menu li.active').closest(".menu-item-object-page"),menuItem=$('.site-main-menu > .menu-item-object-page:not(.menu-item-has-children)');activeItem.prevAll(".site-main-menu > .menu-item-object-page:not(.menu-item-has-children)").children("a").click();menuItem.last().addClass("last-anim");menuItem.first().addClass("first-anim");if(activeItem.hasClass('first-anim')){$('.main-menu .last-anim').children("a").click()}}else{var activeItem=$('.site-main-menu li.active');activeItem.prev("li").children("a").click();if(activeItem.is(':first-child')){$('.site-main-menu li:last-child').children("a").click()}}})}
return{init:init,}})(jQuery);(function($){"use strict";var body=$('body');function imageCarousel(){$('.portfolio-page-carousel').each(function(){var dir=$("html").attr("dir"),rtlVal=!1;if(dir=='rtl'){rtlVal=!0}else{rtlVal=!1}
...
columnStyles();$(this).ajaxComplete(function(){$('style[data-styles="kerge-theme-columns-css"]').remove().detach();columnStyles()})});(function($){"use strict";$(document).ready(function($){var custom_styles="",color="";function ilwiStyles(){$('.info-block-w-icon').each(function(){var color_value=$(this).attr('data-color');var id=$(this).attr('id'),$custom_style='#'+id+'.info-block-w-icon i { color: '+color_value+'; } ';custom_styles+=$custom_style});$('head').append('<style data-styles="kerge-theme-info-list-2-dynamic-css" type="text/css">'+custom_styles+color+'</style>')}
ilwiStyles();$(this).ajaxComplete(function(){$('style[data-styles="kerge-theme-info-list-2-dynamic-css"]').remove().detach();ilwiStyles()})})})(jQuery);(function($){"use strict";$(document).ready(function($){var mobile_mode_items="",tablet_mode_items="",items="",dir=$("html").attr("dir"),rtlVal=!1;if(dir=='rtl'){rtlVal=!0}else{rtlVal=!1}
$('.testimonials').each(function(){var mobile_mode_items=$(this).attr('data-mobile-items'),tablet_mode_items=$(this).attr('data-tablet-items'),items=$(this).attr('data-items'),id=$(this).attr('id'),loop=!1,windowWidth=$(window).width(),autoplayTablet='',autoplayValue='',autoplayTime='',autoplaySpeed=500,slideBy=$(this).attr('data-by-page');if($(this).hasClass('autoplay-on')){autoplayValue=!0;autoplayTime=$(this).attr('data-autotime');autoplaySpeed=$(this).attr('data-speed');if($(this).hasClass('autoplay-mobile')){if(windowWidth>768){autoplayValue=!1}else{autoplayValue=!0}}}else{autoplayValue=!1}
if($(this).hasClass('testimonials-loop-on')){loop=!0}else{loop=!1}
if(slideBy=='page'){slideBy='page'}
$(this).imagesLoaded(function(){$("#"+id+".testimonials.owl-carousel").owlCarousel({nav:!0,dots:!1,items:1,loop:loop,slideBy:slideBy,autoplay:autoplayValue,autoplayTimeout:autoplayTime,smartSpeed:autoplaySpeed,navText:!1,autoHeight:!0,margin:10,rtl:rtlVal,responsive:{0:{items:mobile_mode_items,},768:{items:tablet_mode_items,},1200:{items:items,}}})})})})})(jQuery);(function($){"use strict";$(document).ready(function($){var mobile_mode_items="",tablet_mode_items="",items="",dir=$("html").attr("dir"),rtlVal=!1;if(dir=='rtl'){rtlVal=!0}else{rtlVal=!1}
$('.clients').each(function(){var mobile_mode_items=$(this).attr('data-mobile-items'),tablet_mode_items=$(this).attr('data-tablet-items'),items=$(this).attr('data-items'),id=$(this).attr('id'),loop=!1,windowWidth=$(window).width(),autoplayTablet='',autoplayValue='',autoplayTime='',autoplaySpeed=500,slideBy=$(this).attr('data-by-page');if($(this).hasClass('autoplay-on')){autoplayValue=!0;autoplayTime=$(this).attr('data-autotime');autoplaySpeed=$(this).attr('data-speed');if($(this).hasClass('autoplay-mobile')){if(windowWidth>768){autoplayValue=!1}else{autoplayValue=!0}}}else{autoplayValue=!1}
if($(this).hasClass('clients-loop-on')){loop=!0}else{loop=!1}
if(slideBy=='page'){slideBy='page'}
$("#"+id+".clients.owl-carousel").imagesLoaded().owlCarousel({nav:!0,items:2,loop:loop,dots:!1,slideBy:slideBy,autoplay:autoplayValue,autoplayTimeout:autoplayTime,smartSpeed:autoplaySpeed,navText:!1,margin:10,rtl:rtlVal,autoHeight:!1,responsive:{0:{items:mobile_mode_items,},768:{items:tablet_mode_items,},1200:{items:items,}}})})})})(jQuery);(function($){"use strict";$(document).ready(function($){var custom_styles="",color="";function timelineStyles(){$('.timeline-item').each(function(){var color_value=$(this).attr('data-color');var id=$(this).attr('id'),$custom_style='#'+id+'.timeline-item .item-period { background-color: '+color_value+'; } '+'#'+id+'.timeline-item .item-period:before { border-right: 5px solid '+color_value+'; } ';custom_styles+=$custom_style});$('head').append('<style data-styles="kerge-theme-timeline-dynamic-css" type="text/css">'+custom_styles+color+'</style>')}
timelineStyles();$(this).ajaxComplete(function(){$('style[data-styles="kerge-theme-timeline-dynamic-css"]').remove().detach();timelineStyles()})})})(jQuery);(function($){"use strict";$(document).ready(function($){var custom_styles="",color="";function skillsStyles(){$('.skill-container').each(function(){var value=$(this).attr('data-value'),color_value=$(this).attr('data-color');if(value>=101){value='100'}
if(typeof value!='undefined'){var id=$(this).attr('id'),$custom_style='#'+id+' .skill-percentage { width: '+value+'%; } '+'#'+id+' > div.skill-percentage { background-color: '+color_value+'; } '+'#'+id+'.skill-container { border-color: '+color_value+'; } ';custom_styles+=$custom_style}});$('head').append('<style data-styles="kerge-theme-skills-css" type="text/css">'+custom_styles+color+'</style>')}
skillsStyles();$(this).ajaxComplete(function(){$('style[data-styles="kerge-theme-skills-css"]').remove().detach();skillsStyles()})})})(jQuery);jQuery(document).ready(function($){var custom_styles="";function buttonStyles(){custom_styles="";$('a.btn').each(function(){var margin_top=$(this).attr('data-mtop'),margin_bottom=$(this).attr('data-mbottom');if(typeof margin_top!='undefined'){var id=$(this).attr('id'),$custom_style='#'+id+'.btn { margin-top: '+margin_top+'px; margin-bottom: '+margin_bottom+'px; } ';custom_styles+=$custom_style}});$('head').append('<style data-styles="kerge-theme-button-css" type="text/css">'+custom_styles+'</style>')}
buttonStyles();$(this).ajaxComplete(function(){$('style[data-styles="kerge-theme-button-css"]').remove().detach();buttonStyles()})});(function($){"use strict";$(document).ready(function($){var custom_styles="",color="";function ibStyles(){$('.lm-info-block').each(function(){var color_value=$(this).attr('data-color');var id=$(this).attr('id'),$custom_style='#'+id+'.lm-info-block i { color: '+color_value+'; } ';custom_styles+=$custom_style});$('head').append('<style data-styles="kerge-theme-info-block-dynamic-css" type="text/css">'+custom_styles+color+'</style>')}
ibStyles();$(this).ajaxComplete(function(){$('style[data-styles="kerge-theme-info-block-dynamic-css"]').remove().detach();ibStyles()})})})(jQuery)